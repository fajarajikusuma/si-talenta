...
<body>
    <div class="p-4">
        ...
        // foreach ($pekerjaIndividu as $pekerja) : 
        ?>
        <div class="<?= $i > 0 ? 'page-break' : '' ?>">
            ...
            <ol class="isi">
                ...
                <div class="isi">
                    Bertindak untuk dan atas namanya sendiri, selanjutnya dalam hal ini disebut sebagai PIHAK KEDUA.<br><br>
            ...
            <div class="pasal mb-2">Pasal 1</div>
            <div class="lingkup mb-2">LINGKUP PEKERJAAN</div>
            ...
            <div class="pasal mb-2">Pasal 2</div>
            <div class="lingkup mb-2">PENUGASAN DAN PENEMPATAN</div>
            ...
            <div class="pasal mb-2">Pasal 3</div>
            <div class="lingkup mb-2">HARI KERJA DAN WAKTU KERJA</div>
            ...
            <div class="pasal mb-2">Pasal 4</div>
            <div class="lingkup mb-2">HAK DAN KEWAJIBAN</div>
            ...
            <div class="pasal mb-2">Pasal 5</div>
            <div class="lingkup mb-2">JANGKA WAKTU DAN PEMBAYARAN</div>
            ...
            <div class="pasal mb-2">Pasal 6</div>
            <div class="lingkup mb-2">SANKSI</div>
            ...
            <div class="pasal mb-2">Pasal 7</div>
            <div class="lingkup mb-2">PEMUTUSAN HUBUNGAN KERJA</div>
            ...
            <div class="pasal mb-2">Pasal 8</div>
            <div class="lingkup mb-2">PERSELISIHAN</div>
            ...
            <div class="pasal mb-2">Pasal 9</div>
            <div class="lingkup mb-2">KETENTUAN PENUTUP</div>
