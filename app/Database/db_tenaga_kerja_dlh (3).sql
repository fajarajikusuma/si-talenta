...
('PG250518171715', '3327111704020001', 'FAJAR AJI KUSUMA', 'Pemalang', '2002-04-17', 'L', 'Sawahrejo Utara', '43/08', 'Tegalsari Timur', 'Ampelgading', 'Pemalang', 'Jawa Tengah', '52364', 'KTPPG250518171715.png', 'S1', 'Teknik Informatika', '-', 'S.Kom.', 'IJAZAHPG250518171715.pdf', '2025-05-18 14:38:45', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
...
('PG250519278166', '3325022406940004', 'KISWANTO', 'Batang', '1970-07-15', 'L', 'Jl. Kusuma Bangsa', '21/11', 'Pekalongan', 'Pekalongan Utara', 'Pekalongan', 'Jawa Tengah', '41231', 'KTPPG250519278166.jpeg', 'SMA', 'IPA', '-', '-', 'IJAZAHPG250519278166.pdf', '2025-05-19 05:12:30', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
(8, 1, '197012141990031004', 'Dr. SRI BUDI SANTOSO, M.Si.', 'Kepala Dinas Lingkungan Hidup', 'Kadin Pada DLH Kota Pekalongan', 'Aktif'),
(9, 1, '197606072000122004', 'DWI YUNIASTUTI, S.KM., M.M', 'Sekretaris Dinas', 'Sekdin Pada DLH Kota Pekalongan', 'Aktif'),
...
INSERT INTO `tb_riwayat_pekerjaan` (`id`, `id_pekerja`, `id_nama_pekerjaan`, `jenis_pegawai`, `id_unit_kerja`, `tahun`, `tmt_kerja`, `tst_kerja`, `status`, `penginput`, `created_at`, `updated_at`, `deleted_at`) VALUES
...
(8, 'PG250518237001', 2, 'Kontrak Dinas', 1, '2025', '2025-05-18', '2025-12-31', 'Terverifikasi', 'Admin', '2025-05-18 04:32:04', '2025-05-18 14:36:04', '0000-00-00 00:00:00'),
(9, 'PG250518171715', 2, 'Kontrak Dinas', 1, '2025', '2025-01-01', '2025-12-31', 'Terverifikasi', 'Admin', '2025-05-18 14:38:45', '2025-05-19 02:05:21', '0000-00-00 00:00:00'),
...
(11, 'PG250519278166', 9, 'Kontrak Dinas', 3, '2025', '2025-05-19', '2025-12-31', 'Menunggu', 'Admin', '2025-05-19 05:12:30', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
--
ALTER TABLE `tb_nama_pekerjaan`
  MODIFY `id_nama_pekerjaan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=112;
...
--
ALTER TABLE `tb_unit_kerja`
  MODIFY `id_unit_kerja` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
